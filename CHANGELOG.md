# Ezra Bible Software - Changelog
All notable changes to Ezra Bible Software are documented in this file.
...
* Integrate information "About Ezra Bible Software" in Info Dialog. ([#163](i163))
...
* Fixed a build issue that prevented Ezra Bible Software from working on older macOS 10.x versions. With this issue fixed, it now works from macOS 10.10 (*Yosemite*) and all other subsequent versions. ([#119](i119))
...
* Upgraded to latest SWORD version 1.9.0 (SVN Rev. 3820). This is the first version of Ezra Bible Software using this latest version of SWORD.
...
* Option to show/hide the toolbar (on the left side).
  Based on this option Ezra Bible Software can now also be used on tablets in vertical mode where the horizontal space
  is limited.
...
## [0.8.1] - 2019-06-21
### Features
* Sync functionality for Sword modules that are already existing locally: On startup any modules not yet used by Ezra Bible Software are imported into the database.
...
* Tabbed user interface
  ...
  * Tabs are saved after every change and loaded when starting Ezra Bible Software
...
## [0.6.0] - 2019-02-03
This is the initial public release of Ezra Bible Software for the Linux desktop.
