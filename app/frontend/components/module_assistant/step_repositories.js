...
const SETTINGS_KEY = 'selectedRepositories';
const ICON_STAR = `
...
class StepRepositories extends HTMLElement {
  ...
  async resetView() {
    ...
    assistantController.init('selectedRepositories', []);
  ...
  saveSelected() {
    ipcSettings.set(SETTINGS_KEY, [...assistantController.get('selectedRepositories')]);
  }
