 ...
 */
/**
 * @typedef { "on-startup-completed" | "on-theme-changed" | "on-fullscreen-changed" | "on-button-clicked" | "on-body-clicked" | "on-db-refresh" | "on-hide-menu-request" | "on-menu-opened" } AppEvents
 */
/**
