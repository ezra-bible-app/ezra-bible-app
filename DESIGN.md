...
To access SWORD modules, Ezra Bible Software uses the [node-sword-interface](https://github.com/ezra-project/node-sword-interface) library. This library is implemented in C++ and offers a simple, flat, facade style interface that wraps calls to the SWORD library.
...
This directory contains the JavaScript source code of Ezra Bible Software. It contains the following parts:
